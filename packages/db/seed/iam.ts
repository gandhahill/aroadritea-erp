...
export const PERMISSIONS_SEED = [
  ...
  { code: 'hr.manage_attendance', module: 'hr', description: n('Kelola absensi', 'Manage attendance', '管理考勤') },
  { code: 'hr.attendance.read', module: 'hr', description: n('Lihat data absensi', 'View attendance data', '查看考勤数据') },
  { code: 'hr.attendance.write', module: 'hr', description: n('Catat absensi', 'Record attendance', '记录考勤') },
