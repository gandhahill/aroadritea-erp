 ...
 * SD §31.5.2
 */
export const memberSignupAttempts = pgTable('member_signup_attempts', {
  ...pk,
 ...
 */
export const memberOtpCodes = pgTable('member_otp_codes', {
  ...pk,
  tenantId: text('tenant_id').notNull().default('default'),
 ...
 */
export const memberLoyalty = pgTable('member_loyalty', {
  ...pk,
  tenantId: text('tenant_id').notNull().default('default'),
...
export const memberVouchers = pgTable('member_vouchers', {
  ...pk,
  tenantId: text('tenant_id').notNull().default('default'),
