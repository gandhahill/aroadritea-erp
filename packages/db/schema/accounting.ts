...
// ================================================================
// PARTNERS â€” SD Â§9.2 (unified customer / supplier / employee)
// ================================================================
...
export const partners = pgTable(
  'partners',
  {
    ...
    loyaltyPoints: integer('loyalty_points').notNull().default(0), // T-0260
...
// ================================================================
// TAX RULES â€” SD Â§19.3.2 (PPN opt-in engine, ADR-0010)
// ================================================================
...
export const taxRules = pgTable(
  'tax_rules',
  {
    ...
    scopeId: text('scope_id'), // id of channel/segment/category â€” NULL for global_default
...
// ================================================================
// PETTY CASH TRANSACTIONS â€” SD Â§25.7
// ================================================================
...
// ================================================================
// REIMBURSEMENT REQUESTS â€” SD Â§25.8
// ================================================================
...
// ================================================================
// FIXED ASSET CATEGORIES â€” SoT Â§10.4
// ================================================================
...
// ================================================================
// FIXED ASSET DEPRECIATION RUNS â€” auto-journal batch header
// ================================================================
...
// ================================================================
// FIXED ASSET DEPRECIATION LINES â€” per-asset schedule result
// ================================================================
...
// ================================================================
// JOURNAL ATTACHMENTS â€” SD Â§25.10
// ================================================================
...
// ================================================================
// BANK ACCOUNTS â€” Configurable in settings
// ================================================================
...
// ================================================================
// BANK STATEMENTS â€” Bank Reconciliation (manual import)
// SD Â§1.3: "rekonsiliasi manual cukup"
// ================================================================
...
// ================================================================
// BANK STATEMENT LINES â€” individual bank transactions
// ================================================================
