ALTER TABLE "shift_expenses" ADD COLUMN "status" text DEFAULT 'pending_accounting' NOT NULL;--> statement-breakpoint
ALTER TABLE "shift_expenses" ADD COLUMN "account_id" text;--> statement-breakpoint
