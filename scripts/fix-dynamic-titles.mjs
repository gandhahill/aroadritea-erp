...
const replacements = [
  ...
  [/return \{ title: t\('detail\.title'\) \}/g, "return { title: `${t('detail.title')} | Aroadri ERP` }"],
  // CMS pages: return { title: `${t('title')} - CMS` };
  [/return \{ title: `\$\{t\('title'\)\} - CMS` \}/g, "return { title: `${t('title')} | Aroadri ERP` }"],
  // SOP: return { title: `${t('title')} - Aroadri Tea` };
  [/return \{ title: `\$\{t\('title'\)\} - Aroadri Tea` \}/g, "return { title: `${t('title')} | Aroadri ERP` }"],
  // CMS edit page: return { title: `Edit Page - ${id.slice(0, 8)}. - CMS` };
  [/return \{ title: `Edit Page - \$\{id\.slice\(0, 8\)\}\. - CMS` \}/g, "return { title: `Edit Page - ${id.slice(0, 8)} | Aroadri ERP` }"],
  // CMS edit post: return { title: `Edit Post - ${id.slice(0, 8)}. - CMS` };
  [/return \{ title: `Edit Post - \$\{id\.slice\(0, 8\)\}\. - CMS` \}/g, "return { title: `Edit Post - ${id.slice(0, 8)} | Aroadri ERP` }"],
];
