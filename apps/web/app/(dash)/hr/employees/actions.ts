...
export async function createEmployeeAction(
  ...
  const input: CreateEmployeeInput = {
    ...
    bankAccountNumber: optionalText(formData, 'bankAccountNumber'),
    bankAccountHolder: optionalText(formData, 'bankAccountHolder'),
    vehiclePlateNumber: optionalText(formData, 'vehiclePlateNumber'),
