    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          ...
          'Gunakan Attendance untuk memantau kehadiran.',
          'Gunakan Leave untuk melihat atau memproses cuti.',
          'Jalankan Payroll sesuai periode payroll, lalu review sebelum approval atau pembayaran.',
    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          ...
          'Use Attendance to monitor presence.',
          'Use Leave to review or process leave requests.',
          'Run Payroll for the correct period and review before approval or payment.',
