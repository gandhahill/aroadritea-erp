        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-brand-cream-2 bg-brand-cream/50">
              <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-brand-ink-3">Entry #</th>
              <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-brand-ink-3">Date</th>
              <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-brand-ink-3">Description</th>
              <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-brand-ink-3">Type</th>
              <th className="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wider text-brand-ink-3">Amount</th>
              <th className="px-4 py-3 text-center text-xs font-semibold uppercase tracking-wider text-brand-ink-3">Status</th>
            </tr>
          </thead>
            ...
            {filtered.length === 0 ? (
              ...
              filtered.map((journal) => {
                ...
                return (
                  <tr
                    key={journal.id}
                    className="group transition-colors hover:bg-brand-cream/50"
                  >
