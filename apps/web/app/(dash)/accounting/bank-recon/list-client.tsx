    ...
    <div className="overflow-x-auto rounded-lg border border-brand-cream-3 bg-card">
      <table className="w-full text-left text-sm">
        <thead className="bg-brand-cream-2 text-xs uppercase tracking-widest text-brand-ink-3">
          <tr>
            <TableHead className="px-4 py-3">{labels.statementDate}</TableHead>
            <TableHead className="px-4 py-3">{labels.bankAccount}</TableHead>
            <TableHead className="px-4 py-3 text-right">{labels.openingBalance}</TableHead>
            <TableHead className="px-4 py-3 text-right">{labels.closingBalance}</TableHead>
            <TableHead className="px-4 py-3 text-center">{labels.statusCol}</TableHead>
          </tr>
        </thead>
