    ...
    <>
      ...
      <div className="rounded-xl border border-brand-cream-3 bg-card p-6 shadow-sm">
        ...
        <dl className="mt-4 grid gap-4 md:grid-cols-2">
          ...
          {detail.notes && <Field label={tShipment('subject')} value={detail.notes} span2 />}
        </dl>
      </div>
      ...
      <div className="rounded-xl border border-brand-cream-3 bg-card p-6 shadow-sm">
        ...
        >
          <div>
            ...
            <Select
              name="courierCode"
              defaultValue={detail.courierCode ?? ''}
              className="w-full"
            >
          ...
          <div>
            <label className="text-xs font-semibold text-brand-ink-3 invisible">.</label>
            <Button
              type="submit"
              disabled={syncing}
              variant="primary"
