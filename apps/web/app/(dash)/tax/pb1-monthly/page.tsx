...
export async function generateMetadata() {
  ...
  return {
    title: `${t('monthlyPb1Summary')} - Aroadri Tea ERP`,
  };
}
  ...
  return (
    <div className="flex-1 space-y-4 p-8 pt-6">
      <div className="flex items-center justify-between space-y-2">
        <h2 className="text-3xl font-bold tracking-tight">Rekap PB1 Bulanan (SPTPD)</h2>
      </div>
      <div className="hidden items-center space-x-2 md:flex">
        <p className="text-muted-foreground">
          Laporan Rekapitulasi Pajak Restoran (PB1) bulanan per outlet untuk pelaporan e-SPTPD / e-PBJT Pemda.
        </p>
      </div>
