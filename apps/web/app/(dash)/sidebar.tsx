...
export function Sidebar({
  ...
  const NAV_ITEMS: NavItem[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { label: t('equityChanges'), href: '/reporting/equity-changes', icon: <></> },
        { label: t('generalLedger'), href: '/reporting/general-ledger', icon: <></> },
    ...
    },
    {
      ...
      children: [
        ...
        { label: t('uomConversions'), href: '/inventory/uom-conversions', icon: <></> },
    ...
    },
    {
      ...
      children: [
        ...
        { label: t('masterShifts'), href: '/hr/schedule/shifts', icon: <></> },
  ...
  const PATH_TO_MODULE: Record<string, string> = {
    ...
    '/reporting/balance-sheet': 'accounting.reports',
    '/reporting/profit-loss': 'accounting.reports',
    '/reporting/cash-flow': 'accounting.reports',
    '/reporting/equity-changes': 'accounting.reports',
    '/reporting/general-ledger': 'accounting.reports',
    '/reporting/aging-receivables': 'accounting.reports',
    '/reporting/aging-payables': 'accounting.reports',
    '/reporting/cogs': 'accounting.reports',
    ...
    '/inventory/uom-conversions': 'inventory.product',
    ...
    '/hr/schedule/shifts': 'hr.manage_attendance',
    '/hr/attendance': 'hr.attendance',
    '/hr/leave': 'hr.approve_leave',
    '/hr/kasbon': 'hr.payroll',
    '/hr/overtime': 'hr.manage_attendance',
