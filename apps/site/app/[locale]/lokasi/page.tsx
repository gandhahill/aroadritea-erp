  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-12">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {STORES.map((s) => (
          <div key={s.name} className="rounded-xl border border-brand-cream-3 bg-white p-6 shadow-sm">
...
const STORES = [
  { name: 'Toko Malioboro', address: 'Malioboro Mall, Yogyakarta', hours: '10:00 – 22:00 WIB', phone: '(0274)' },
  { name: 'Toko Plaza Malioboro', address: 'Plaza Malioboro, Yogyakarta', hours: '10:00 – 22:00 WIB', phone: '(0274)' },
