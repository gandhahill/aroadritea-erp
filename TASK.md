...
|----|-------|-------|---------|-------------|--------|------|
| T-0193 | Patch ERP bug batch: petty cash, variants, HR edit, POS orders, AI OCR/chat attachments | Codex | 2026-05-27 10:32 WIB | 2026-05-27 11:15 WIB | 🟨 IN_PROGRESS | User-reported critical/major/minor bug batch: petty cash open crash, variant validation UX, employee edit/decrypt display, POS order history active shift, COA row edit UX, payment amount label, dashboard greeting, journal location display, OCR execution failure, AI chat attachment visibility. |
