...
|----|-------|-------|---------|-------------|--------|------|
| T-0289 | F0.1 - CI master branch and i18n parity job | Codex | 2026-06-10 19:51 WIB | 2026-06-10 19:51 WIB | IN_PROGRESS | Execute master plan card F0.1: enable CI on `master`, make `scripts/check-i18n.mjs` cwd-independent, and add i18n parity to CI. Checkpoint: `docs/checkpoints/T-0289-f0-1-ci-master-i18n.checkpoint.md`. |
