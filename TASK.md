...
|----|-------|-------|---------|-------------|--------|------|
| T-0191 | Patch VPS pentest infra + AI lookup/OCR + UI cleanup | Codex | 2026-05-27 05:49 WIB | 2026-05-27 06:09 WIB | IN_PROGRESS | User melaporkan INF VPS belum benar-benar dipatch, AI lookup masih bingung alias outlet/produk, upload OCR masih provider 400, angka qty tampil `0.000`, i18n scheduled job mentah, dan sidebar duplikat. |
