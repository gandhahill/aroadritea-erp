...
|----|-------|-------|---------|-------------|--------|------|
| T-0281 | Pentest 2026-06-07 remediation verification | Codex | 2026-06-09 11:30 WIB | 2026-06-09 13:13 WIB | IN_PROGRESS | Repo patch for security headers/no-store/open-redirect guard is locally verified; origin internal ports are currently filtered; DNS SPF/DMARC remains Cloudflare-side. Checkpoint: `docs/checkpoints/T-0281-pentest-2026-06-07-remediation.checkpoint.md`. |
