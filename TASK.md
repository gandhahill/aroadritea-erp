...
| G1 | Modifier picker UI (gula/es/topping) — full Finding 1 remediation | **P0** | L | Perlu ADR kecil (kolom `groupRole` di `product_modifier_groups`). |
