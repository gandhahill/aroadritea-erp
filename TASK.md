...
|----|-------|-------|-----------|--------|------|
| T-0280 | UX/HCI audit and Dependabot warning remediation | Codex | 2026-06-09 | `5db1dea` + `this commit` | Resolved current npm audit/Dependabot advisories by bumping `better-auth` and `hono`; swept Settings UX/HCI for hardcoded UI text, i18n parity, aria labels, placeholders, and brand-token compliance. Verified GitHub Dependabot API `open_dependabot_alerts=0`, audit, web/services/MCP typecheck, web build, i18n parity, and diff check. |
