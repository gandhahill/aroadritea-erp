...
|----|-------|-------|---------|-------------|--------|------|
| T-0282 | HR my attendance dispensation reason and locale UX audit | Codex | 2026-06-09 15:45 WIB | 2026-06-09 15:58 WIB | IN_PROGRESS | `/hr/my-attendance` now shows absence dispensation reasons and late-forgiveness reasons; HR attendance locale copy is less technical; corrupted `??` Mandarin strings removed. Verification: web typecheck, services typecheck, scoped Biome, i18n parity, no `??` in locale files. Checkpoint: `docs/checkpoints/T-0282-hr-my-attendance-locale.checkpoint.md`. |
