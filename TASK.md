...
|----|-------|-------|---------|-------------|--------|------|
| T-0283 | ERP-wide feature completeness and flexibility audit | Codex | 2026-06-09 16:13 WIB | 2026-06-09 16:13 WIB | IN_PROGRESS | Audit all ERP modules against SOURCE-OF-TRUTH/SYSTEM-DESIGN, best-practice ERP controls, flexibility/configuration, i18n, audit trail, permission, and MCP coverage. Checkpoint: `docs/checkpoints/T-0283-erp-wide-feature-completeness-audit.checkpoint.md`. |
