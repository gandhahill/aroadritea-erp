...
| G4 | Toggle "86" produk (`isAvailable`/`is86dAt`) + tombol POS + auto-grey di `product-search.tsx` | **P0** | S | Quick win kecil, dampak terlihat tinggi. |
