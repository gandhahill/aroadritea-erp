...
|----|-------|-------|---------|-------------|--------|------|
| T-0277 | Production SOP PDF preview Not Found regression | Codex | 2026-06-03 20:53 WIB | 2026-06-03 20:53 WIB | IN_PROGRESS | Investigate production `/hr/sop` PDF preview returning Not Found after same-origin header fix; verify SSH deploy, upload keys, and storage paths. Checkpoint: `docs/checkpoints/T-0277-prod-sop-pdf-not-found-regression.checkpoint.md`. |
