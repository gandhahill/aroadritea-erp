...
|----|-------|-------|---------|-------------|--------|------|
| T-0266 | Typecheck remediation + functional bug hunt sweep across ERP modules | Codex | 2026-06-02 11:21 WIB | 2026-06-02 22:26 WIB | IN_PROGRESS | Parallel remediation active across access-control, MCP/worker, POS/offline/KDS, inventory/purchasing, payroll/accounting, and inline attendance face verification. Access-control/data-scope and inventory/purchasing service correctness fixes are patched; targeted GRN/transfer tests PASS. Typecheck remains blocked by parallel/non-scope POS changes. Checkpoint: `docs/checkpoints/T-0266-typecheck-functional-bughunt.checkpoint.md`. |
