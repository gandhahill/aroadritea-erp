...
| T-0168 | Security audit and overnight operational fixes | Codex | 2026-05-21 19:24 WIB | 2026-05-21 19:51 WIB (Codex) | IN_PROGRESS | Baseline `5970cfc`, member reset `e52d7e7`. AP/AR reminder query + party-ledger email channel fixed locally; next: manual sales scroll and outlet dropdown sweep. |
