...
|----|-------|-------|---------|-------------|--------|------|
| T-0266 | Typecheck remediation + functional bug hunt sweep across ERP modules | Codex | 2026-06-02 11:21 WIB | 2026-06-02 21:24 WIB | IN_PROGRESS | Hotfix `/hr/attendance` production crash from invalid `users.name` select pushed and deployed; web build/restart PASS. Continue broad bug-hunt remediation from checkpoint. Checkpoint: `docs/checkpoints/T-0266-typecheck-functional-bughunt.checkpoint.md`. |
