...
|----|-------|-------|---------|-------------|--------|------|
| T-0266 | Typecheck remediation + functional bug hunt sweep across ERP modules | Codex | 2026-06-02 11:21 WIB | 2026-06-02 21:13 WIB | IN_PROGRESS | Hotfix `/hr/attendance` production crash from invalid `users.name` select pushed in `f5919ac`; typecheck PASS. Continue broad bug-hunt remediation from checkpoint. Checkpoint: `docs/checkpoints/T-0266-typecheck-functional-bughunt.checkpoint.md`. |
