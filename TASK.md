...
|----|-------|-------|---------|-------------|--------|------|
| T-0266 | Typecheck remediation + functional bug hunt sweep across ERP modules | Codex | 2026-06-02 11:21 WIB | 2026-06-02 22:19 WIB | IN_PROGRESS | Parallel remediation active across access-control, MCP/worker, POS/offline/KDS, inventory/purchasing, payroll/accounting, and inline attendance face verification. Access-control/data-scope UI/action fixes are patched; web typecheck is currently blocked by parallel worker changes. Checkpoint: `docs/checkpoints/T-0266-typecheck-functional-bughunt.checkpoint.md`. |
