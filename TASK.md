...
|----|-------|-------|---------|-------------|--------|------|
| T-0285 | Manual journal posting approval-gate integration | Codex | 2026-06-09 22:01 WIB | 2026-06-09 22:01 WIB | IN_PROGRESS | Wire the reusable approval gate into manual journal posting so configurable workflow rules can stop sensitive GL postings before they become immutable. Checkpoint: `docs/checkpoints/T-0285-manual-journal-posting-approval-gate.checkpoint.md`. |
