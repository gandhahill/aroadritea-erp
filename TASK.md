...
|----|-------|-------|-----------|--------|------|
| T-0269 | Dependabot security updates for Vitest and tmp advisories | Codex | 2026-06-03 | `this commit` | Resolved current dependency advisories by upgrading Vitest to 4.1.x and overriding transitive `tmp` to patched 0.2.x. Verified audit, typecheck, shared tests, and targeted services tests. |
