...
| T-0101 | Service attendance check-in (mobile, GPS) | Claude Opus 4.6 | 2026-05-11 | 2026-05-11 | 🟩 DONE | e9eebc1 |
...
| T-0104 | Warning letter SP1/SP2/SP3 (service + MCP + UI) | hr | SD §21.8 | M | 🟩 done (f8150d3) |

### Phase 5 — Public Website + CMS + Member + CRM + Loyalty

| ID | Title | Module | Spec link | Estimate |
|----|-------|--------|-----------|----------|
| T-0120 | Schema cms (pages, posts, banners, faqs, settings, revisions) | cms | SD §31.2, ADR-0003 | M | 🟩 done (2aa4f35) |
| T-0121 | Service cms (CRUD, publish, ISR webhook) | cms | SD §31.4 | L | 🟩 done (2aa4f35) |
...
| T-0126 | Member portal /id/member/akun (point balance, QR card, history) | site | SD §31.5, §31.7 | L | 🟩 done (6249b38) |
| T-0127 | Service crm + complaints + compensation tracking | crm | SD §21.9 | M | 🟩 done (1c23017) |
| T-0128 | Service loyalty (points, tiers, vouchers) | crm | SD §21.9 | L | 🟩 done (1c23017) | loyalty earn in pos.createSale + redeemLoyaltyPoints |
...
| T-0152 | UI Settings → Custom Fields | ui | SD §17.3 | L | 🟩 done | b912783 | Entity tabs, CRUD modal, optimistic updates |
...
| T-0156 | Full MCP tools per module (cms, member, hr, payroll, crm, kitchen) | mcp | SD §16 | XL | 🟩 done | 4a8ec8b | All tool handlers implemented (POS, HR, Audit done; CMS member already in phase2 stubs) |
