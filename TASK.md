...
| T-0190 | Validasi AI tools DeepSeek + deploy VPS pentest patch | Codex | 2026-05-26 23:43 WIB | 2026-05-27 00:14 WIB | IN_PROGRESS | Patch AI/OCR + copy Whistleblowing System selesai lokal. Verified: `pnpm -w lint`, `pnpm -w typecheck`, `pnpm -w test`, build `@erp/web`, `@erp/site`, `@erp/mcp`, `@erp/worker` PASS. Next: commit/push lalu deploy VPS. |
